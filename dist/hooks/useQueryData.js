...
export var useQueryData = function useQueryData(endpoint) {
  ...
  var shapeNormalizer = function shapeNormalizer(data) {
    switch (options.dataShape) {
      case "array":
        return Array.isArray(data) ? data : [];
      case "object":
        return _typeof(data) === "object" && !Array.isArray(data) ? data : {};
      default:
        return data;
    }
  };
        ...
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios.get(url, {
              timeout: (_options$fetchTimeout = options.fetchTimeout) !== null && _options$fetchTimeout !== void 0 ? _options$fetchTimeout : 0
            });
          case 2:
